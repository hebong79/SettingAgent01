...
| 20000ms | 30 | 36 | 16156 | 60.5 |
  ...
  - ✅ **27-B 가 「미해소 불일치」로 남긴 건(시작까지 중앙값 내 31 vs 27-B 17)은 해소됐다 — 내 오류였다.** 내 집계 스크립트가 `시작까지` 통계만 **필터 전 46쌍 전체**에 대해 냈다(간격은 29건으로 걸러 놓고). 같은 29건으로 다시 내면 **17ms** 로 27-B 와 정확히 일치한다. min 3 · max 335 는 원래부터 일치했다. **양쪽 다 「17ms」로 적으면 되고, 중앙값을 빼야 할 이유는 없다.**
